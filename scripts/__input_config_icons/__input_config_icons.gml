...
//.add("gamepad thumbstick l up",    "thumbstick up")
//.add("gamepad thumbstick l down",  "thumbstick down")
//.add("gamepad thumbstick r left",  "ds_cardLevel left")
//.add("gamepad thumbstick r right", "ds_cardLevel right")
//.add("gamepad thumbstick r up",    "ds_cardLevel up")
//.add("gamepad thumbstick r down",  "ds_cardLevel down")
//
////Sega Saturn
...
//.add("gamepad trigger r",  "ds_cardLevel")
